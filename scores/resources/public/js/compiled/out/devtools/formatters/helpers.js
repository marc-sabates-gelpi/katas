...
var G__39016 = devtools.prefs.pref.call(null,v);
v = G__39016;
continue;
} else {
return v;
...
}catch (e39019){var _e__38034__auto__ = e39019;
return false;
}})();
...
}catch (e39023){var _e__38034__auto__ = e39023;
return false;
}})();
...
}catch (e39025){var _e__38034__auto__ = e39025;
return false;
}}
}
});
...
var vec__39027 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__39027,(0),null);
var name = cljs.core.nth.call(null,vec__39027,(1),null);
...
return cljs.core.some.call(null,(function (p1__39030_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__39030_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1504451423851
