...
var file = cljs.core.get.call(null,map__40743__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__40743__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__40743__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e40742){var _e = e40742;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__4655__auto___40745 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__4655__auto___40745)){
var seen_errors_40746 = temp__4655__auto___40745;
if(cljs.core.truth_(seen_errors_40746.has(self))){
} else {
seen_errors_40746.add(self);

var temp__4657__auto___40747 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__4657__auto___40747)){
var sense_40748 = temp__4657__auto___40747;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_40748)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1504549437155
