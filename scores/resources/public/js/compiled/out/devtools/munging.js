...
var temp__4655__auto____$1 = (o38914["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o38915 = temp__4655__auto____$1;
return (o38915["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38027__auto__ = f;
return (o__38027__auto__["toString"]).call(o__38027__auto__);
} else {
return "";
}
}catch (e38916){var _ = e38916;
return "";
}});
...
try{var o__38027__auto___38918 = t;
(o__38027__auto___38918["cljs$lang$ctorPrWriter"]).call(o__38027__auto___38918,t,writer);
}catch (e38917){var __38919 = e38917;
}
...
var char_code = (function (){var o__38027__auto__ = (new String(char$));
return (o__38027__auto__["charCodeAt"]).call(o__38027__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38027__auto__ = String;
return (o__38027__auto__["fromCharCode"]).call(o__38027__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__38920 = num_code;
switch (G__38920) {
case (1):
return (185);
...
var o__38027__auto__ = String;
return (o__38027__auto__["fromCharCode"]).call(o__38027__auto__,superscript_code);
});
/**
...
}catch (e38922){var _e__38034__auto__ = e38922;
return false;
}})())){
...
var vec__38923 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__38923,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o38926 = temp__4655__auto__;
var temp__4655__auto____$1 = (o38926["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o38927 = temp__4655__auto____$1;
return (o38927["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__38930){
var vec__38931 = p__38930;
var ns_detector = cljs.core.nth.call(null,vec__38931,(0),null);
...
var G__38937 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__38938 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__38937;
remaining_tokens = G__38938;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq38928){
var G__38929 = cljs.core.first.call(null,seq38928);
var seq38928__$1 = cljs.core.next.call(null,seq38928);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__38929,seq38928__$1);
});
...
var vec__38942 = cljs.core.split_with.call(null,(function (p1__38941_SHARP_){
return cljs.core.not_EQ_.call(null,p1__38941_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__38942,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__38942,(1),null);
...
var vec__38945 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__38945,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__38945,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__38948 = cljs.core.rest.call(null,remaining_tokens);
var G__38949 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__38948;
name_tokens = G__38949;
continue;
} else {
...
var vec__38952 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__38952,(0),null);
var arity = cljs.core.nth.call(null,vec__38952,(1),null);
var vec__38955 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__38955,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__38955,(1),null);
var vec__38958 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__38958,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__38958,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__38958,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__38958,(3),null);
...
var vec__38964 = result;
var munged_ns = cljs.core.nth.call(null,vec__38964,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__38964,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__38964,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__38964,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__38964,(4),null);
var arity = cljs.core.nth.call(null,vec__38964,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__38968 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__38968,(0),null);
var args = cljs.core.nth.call(null,vec__38968,(1),null);
var vec__38971 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__38971,(0),null);
var name = cljs.core.nth.call(null,vec__38971,(1),null);
...
var G__38974 = (arity + (1));
var G__38975 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__38976){
var vec__38977 = p__38976;
var arity = cljs.core.nth.call(null,vec__38977,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__38977,(1),null);
...
return cljs.core.get.call(null,arities,p1__38980_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__38981_SHARP_);
...
var args__29462__auto__ = [];
var len__29455__auto___38988 = arguments.length;
var i__29456__auto___38989 = (0);
while(true){
if((i__29456__auto___38989 < len__29455__auto___38988)){
args__29462__auto__.push((arguments[i__29456__auto___38989]));

var G__38990 = (i__29456__auto___38989 + (1));
i__29456__auto___38989 = G__38990;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__38984){
var vec__38985 = p__38984;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__38985,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq38982){
var G__38983 = cljs.core.first.call(null,seq38982);
var seq38982__$1 = cljs.core.next.call(null,seq38982);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__38983,seq38982__$1);
});
...
var map__38993 = options;
var map__38993__$1 = ((((!((map__38993 == null)))?((((map__38993.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__38993.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__38993):map__38993);
var include_ns_QMARK_ = cljs.core.get.call(null,map__38993__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__38993__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__38993__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__38993__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__38994 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__38994,(0),null);
var fn_name = cljs.core.nth.call(null,vec__38994,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__38994,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__38994,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__38994,(4),null);
var arity = cljs.core.nth.call(null,vec__38994,(5),null);
...
var o__38027__auto__ = f;
return (o__38027__auto__["getBasis"]).call(o__38027__auto__);
});
/**
...
}catch (e38998){var _e__38034__auto__ = e38998;
...
var G__38999 = (obj[cljs.core.first.call(null,path)]);
var G__39000 = cljs.core.rest.call(null,path);
obj = G__38999;
path = G__39000;
continue;
} else {
...
return (function (accum,p__39001){
var vec__39002 = p__39001;
var bit = cljs.core.nth.call(null,vec__39002,(0),null);
var protocol = cljs.core.nth.call(null,vec__39002,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39005){
var vec__39006 = p__39005;
var ns = cljs.core.nth.call(null,vec__39006,(0),null);
var name = cljs.core.nth.call(null,vec__39006,(1),null);
var selector = cljs.core.nth.call(null,vec__39006,(2),null);
...
return (function (p__39010){
var vec__39011 = p__39010;
var munged_name = cljs.core.nth.call(null,vec__39011,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39011,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39011,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39009_SHARP_){
return (obj[cljs.core.first.call(null,p1__39009_SHARP_)]);
});})(name,sorted_matches,vec__39011,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1504451423701
