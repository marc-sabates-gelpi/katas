...
var o38923 = temp__4655__auto__;
var temp__4655__auto____$1 = (o38923["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o38924 = temp__4655__auto____$1;
return (o38924["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__38036__auto__ = f;
return (o__38036__auto__["toString"]).call(o__38036__auto__);
} else {
return "";
}
}catch (e38925){var _ = e38925;
return "";
}});
...
try{var o__38036__auto___38927 = t;
(o__38036__auto___38927["cljs$lang$ctorPrWriter"]).call(o__38036__auto___38927,t,writer);
}catch (e38926){var __38928 = e38926;
}
...
var char_code = (function (){var o__38036__auto__ = (new String(char$));
return (o__38036__auto__["charCodeAt"]).call(o__38036__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__38036__auto__ = String;
return (o__38036__auto__["fromCharCode"]).call(o__38036__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__38929 = num_code;
switch (G__38929) {
case (1):
return (185);
...
var o__38036__auto__ = String;
return (o__38036__auto__["fromCharCode"]).call(o__38036__auto__,superscript_code);
});
/**
...
}catch (e38931){var _e__38043__auto__ = e38931;
return false;
}})())){
...
var vec__38932 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__38932,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o38935 = temp__4655__auto__;
var temp__4655__auto____$1 = (o38935["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o38936 = temp__4655__auto____$1;
return (o38936["nameToPath"]);
} else {
return null;
}
} else {
...
var len__29455__auto___38943 = arguments.length;
var i__29456__auto___38944 = (0);
while(true){
if((i__29456__auto___38944 < len__29455__auto___38943)){
args__29462__auto__.push((arguments[i__29456__auto___38944]));

var G__38945 = (i__29456__auto___38944 + (1));
i__29456__auto___38944 = G__38945;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__38939){
var vec__38940 = p__38939;
var ns_detector = cljs.core.nth.call(null,vec__38940,(0),null);
...
var G__38946 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__38947 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__38946;
remaining_tokens = G__38947;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq38937){
var G__38938 = cljs.core.first.call(null,seq38937);
var seq38937__$1 = cljs.core.next.call(null,seq38937);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__38938,seq38937__$1);
});
...
var vec__38951 = cljs.core.split_with.call(null,(function (p1__38950_SHARP_){
return cljs.core.not_EQ_.call(null,p1__38950_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__38951,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__38951,(1),null);
...
var vec__38954 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__38954,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__38954,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__38957 = cljs.core.rest.call(null,remaining_tokens);
var G__38958 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__38957;
name_tokens = G__38958;
continue;
} else {
...
var vec__38961 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__38961,(0),null);
var arity = cljs.core.nth.call(null,vec__38961,(1),null);
var vec__38964 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__38964,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__38964,(1),null);
var vec__38967 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__38967,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__38967,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__38967,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__38967,(3),null);
...
var vec__38973 = result;
var munged_ns = cljs.core.nth.call(null,vec__38973,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__38973,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__38973,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__38973,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__38973,(4),null);
var arity = cljs.core.nth.call(null,vec__38973,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__38977 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__38977,(0),null);
var args = cljs.core.nth.call(null,vec__38977,(1),null);
var vec__38980 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__38980,(0),null);
var name = cljs.core.nth.call(null,vec__38980,(1),null);
...
var G__38983 = (arity + (1));
var G__38984 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__38985){
var vec__38986 = p__38985;
var arity = cljs.core.nth.call(null,vec__38986,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__38986,(1),null);
...
return cljs.core.get.call(null,arities,p1__38989_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__38990_SHARP_);
...
var args__29462__auto__ = [];
var len__29455__auto___38997 = arguments.length;
var i__29456__auto___38998 = (0);
while(true){
if((i__29456__auto___38998 < len__29455__auto___38997)){
args__29462__auto__.push((arguments[i__29456__auto___38998]));

var G__38999 = (i__29456__auto___38998 + (1));
i__29456__auto___38998 = G__38999;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__38993){
var vec__38994 = p__38993;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__38994,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq38991){
var G__38992 = cljs.core.first.call(null,seq38991);
var seq38991__$1 = cljs.core.next.call(null,seq38991);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__38992,seq38991__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__39002__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39002__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39002__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39002__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39003 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39003,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39003,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39003,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39003,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39003,(4),null);
var arity = cljs.core.nth.call(null,vec__39003,(5),null);
...
var o__38036__auto__ = f;
return (o__38036__auto__["getBasis"]).call(o__38036__auto__);
});
/**
...
}catch (e39007){var _e__38043__auto__ = e39007;
...
var G__39008 = (obj[cljs.core.first.call(null,path)]);
var G__39009 = cljs.core.rest.call(null,path);
obj = G__39008;
path = G__39009;
continue;
} else {
...
return (function (accum,p__39010){
var vec__39011 = p__39010;
var bit = cljs.core.nth.call(null,vec__39011,(0),null);
var protocol = cljs.core.nth.call(null,vec__39011,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39014){
var vec__39015 = p__39014;
var ns = cljs.core.nth.call(null,vec__39015,(0),null);
var name = cljs.core.nth.call(null,vec__39015,(1),null);
var selector = cljs.core.nth.call(null,vec__39015,(2),null);
...
return (function (p__39019){
var vec__39020 = p__39019;
var munged_name = cljs.core.nth.call(null,vec__39020,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39020,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39020,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39018_SHARP_){
return (obj[cljs.core.first.call(null,p1__39018_SHARP_)]);
});})(name,sorted_matches,vec__39020,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1504549431696
