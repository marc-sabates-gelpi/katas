...
if(typeof devtools.toolbox.t_devtools$toolbox40548 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox40548 = (function (obj,header,style,tag,meta40549){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox40548.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_40550,meta40549__$1){
var self__ = this;
var _40550__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox40548(self__.obj,self__.header,self__.style,self__.tag,meta40549__$1));
});

devtools.toolbox.t_devtools$toolbox40548.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_40550){
var self__ = this;
var _40550__$1 = this;
return self__.meta40549;
});

devtools.toolbox.t_devtools$toolbox40548.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL;

devtools.toolbox.t_devtools$toolbox40548.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox40548.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox40548.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox40548.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta40549","meta40549",-281132527,null)], null);
});

devtools.toolbox.t_devtools$toolbox40548.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox40548.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox40548";

devtools.toolbox.t_devtools$toolbox40548.cljs$lang$ctorPrWriter = (function (this__28911__auto__,writer__28912__auto__,opt__28913__auto__){
return cljs.core._write.call(null,writer__28912__auto__,"devtools.toolbox/t_devtools$toolbox40548");
});

devtools.toolbox.__GT_t_devtools$toolbox40548 = (function devtools$toolbox$__GT_t_devtools$toolbox40548(obj__$1,header__$1,style__$1,tag__$1,meta40549){
return (new devtools.toolbox.t_devtools$toolbox40548(obj__$1,header__$1,style__$1,tag__$1,meta40549));
});

}

return (new devtools.toolbox.t_devtools$toolbox40548(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1504451428990
