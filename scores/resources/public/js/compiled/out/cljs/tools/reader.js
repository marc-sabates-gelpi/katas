...
var G__30904 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__30904;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__30905 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__30905,ch);
...
if(("\\" === ch__$1)){
var ch_30906__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_30906__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_30906__$2);
} else {
}

var G__30907 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__30907;
continue;
}
}
...
var vec__30915 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__30915,(0),null);
var start_column = cljs.core.nth.call(null,vec__30915,(1),null);
...
var G__30918 = cljs.core.conj_BANG_.call(null,a,form);
a = G__30918;
continue;
}
}
...
var _STAR_read_delim_STAR_30919 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_30919;
}});
/**
...
var start_line = cljs.core.nth.call(null,vec__30920,(0),null);
var start_column = cljs.core.nth.call(null,vec__30920,(1),null);
...
var vec__30923 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__30923,(0),null);
var end_column = cljs.core.nth.call(null,vec__30923,(1),null);
...
var vec__30926 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__30926,(0),null);
var start_column = cljs.core.nth.call(null,vec__30926,(1),null);
...
var vec__30929 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__30929,(0),null);
var end_column = cljs.core.nth.call(null,vec__30929,(1),null);
...
var vec__30932 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__30932,(0),null);
var start_column = cljs.core.nth.call(null,vec__30932,(1),null);
...
var vec__30935 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__30935,(0),null);
var end_column = cljs.core.nth.call(null,vec__30935,(1),null);
...
var G__30940 = (function (){var G__30939 = sb;
G__30939.append(ch);

return G__30939;
})();
var G__30941 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__30940;
ch = G__30941;
continue;
}
...
switch (G__30944) {
case "\\":
var G__30948 = (function (){var G__30945 = sb;
G__30945.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__30945;
})();
var G__30949 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__30948;
ch = G__30949;
continue;
...
break;
default:
var G__30950 = (function (){var G__30946 = sb;
G__30946.append(ch);

return G__30946;
})();
var G__30951 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__30950;
ch = G__30951;
continue;
...
var vec__30952 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__30952,(0),null);
var end_column = cljs.core.nth.call(null,vec__30952,(1),null);
...
var vec__30955 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__30955,(0),null);
var column = cljs.core.nth.call(null,vec__30955,(1),null);
...
var line = cljs.core.nth.call(null,vec__30960,(0),null);
var column = cljs.core.nth.call(null,vec__30960,(1),null);
...
var vec__30965 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__30965,(0),null);
var column = cljs.core.nth.call(null,vec__30965,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var G__30976 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__30976,true,null,opts,pending_forms);
...
var _STAR_suppress_read_STAR_30977 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_30977;
}});
...
var G__30978 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__30978,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__30978,rdr,first_line);
...
var G__30982 = matched;
var G__30983 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__30982;
finished = G__30983;
continue;
} else {
...
var _STAR_suppress_read_STAR_30984 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_30984;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env30985 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__30986 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__30986,"(");
...
var G__30987 = (i + (1));
var G__30988 = cljs.core.conj_BANG_.call(null,args,(function (){var or__28286__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__28286__auto__)){
return or__28286__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env30985;
}});
/**
...
var ch = temp__4655__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__30989 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__30989);
...
var G__30990 = cljs.core.next.call(null,s__$1);
var G__30991 = ret;
s__$1 = G__30990;
r = G__30991;
continue;
...
var G__30992 = cljs.core.next.call(null,s);
var G__30993 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__30992;
key_vals = G__30993;
continue;
} else {
...
var gensym_env30997 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env30997;
}});
...
var temp__4655__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__30998 = token;
var G__30998__$1 = (((G__30998 == null))?null:cljs.core.subs.call(null,G__30998,(1)));
var G__30998__$2 = (((G__30998__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__30998__$1));
var G__30998__$3 = (((G__30998__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__30998__$2));
var G__30998__$4 = (((G__30998__$3 == null))?null:cljs.core.symbol.call(null,G__30998__$3));
if((G__30998__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__30998__$4);
}
})():(function (){var G__30999 = token;
var G__30999__$1 = (((G__30999 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__30999));
if((G__30999__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__30999__$1);
}
})()
));
if(cljs.core.truth_(temp__4655__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__31010,reader){
...
var eof = cljs.core.get.call(null,map__31011__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1504451407063
