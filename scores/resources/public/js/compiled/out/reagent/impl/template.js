...
var G__30275 = o;
(G__30275[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__30281 = jsprops;
(G__30281["defaultValue"] = value);

(G__30281["onChange"] = ((function (G__30281,v,value,on_change){
return (function (p1__30280_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__30280_SHARP_);
});})(G__30281,v,value,on_change))
);
...
var vec__30284 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__30284,(0),null);
var id = cljs.core.nth.call(null,vec__30284,(1),null);
var class$ = cljs.core.nth.call(null,vec__30284,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___30288 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___30288 == null)){
} else {
var key_30289 = temp__4661__auto___30288;
(jsprops["key"] = key_30289);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__30290 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__30290["name"] = c);
...
var len__29455__auto___30295 = arguments.length;
var i__29456__auto___30296 = (0);
while(true){
if((i__29456__auto___30296 < len__29455__auto___30295)){
args__29462__auto__.push((arguments[i__29456__auto___30296]));

var G__30297 = (i__29456__auto___30296 + (1));
i__29456__auto___30296 = G__30297;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq30293){
var G__30294 = cljs.core.first.call(null,seq30293);
var seq30293__$1 = cljs.core.next.call(null,seq30293);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__30294,seq30293__$1);
});
...
break;
default:
var G__30300 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__30300;
continue;
...
var n__29231__auto___30302 = a.length;
var i_30303 = (0);
while(true){
if((i_30303 < n__29231__auto___30302)){
(a[i_30303] = reagent.impl.template.as_element.call(null,(a[i_30303])));
...
var a = cljs.core.into_array.call(null,s);
var n__29231__auto___30305 = a.length;
var i_30306 = (0);
while(true){
if((i_30306 < n__29231__auto___30305)){
var val_30307 = (a[i_30306]);
if((cljs.core.vector_QMARK_.call(null,val_30307)) && ((reagent.impl.template.key_from_vec.call(null,val_30307) == null))){
(o["no-key"] = true);
} else {
}

(a[i_30306] = reagent.impl.template.as_element.call(null,val_30307));

var G__30308 = (i_30306 + (1));
i_30306 = G__30308;
continue;
} else {
}
...
var ctx = ({});
var vec__30309 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__30309,(0),null);
var derefed = cljs.core.nth.call(null,vec__30309,(1),null);
...
var G__30312 = (cljs.core.count.call(null,argv) - first_child);
switch (G__30312) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__30312){
...
//# sourceMappingURL=template.js.map?rel=1504549413923
