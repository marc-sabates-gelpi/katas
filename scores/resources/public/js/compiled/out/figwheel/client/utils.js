...
return (new CustomEvent(event_name,(function (){var obj35679 = {"detail":data};
return obj35679;
})()));
} else {
...
var f = (function (){var pred__35686 = cljs.core._EQ_;
var expr__35687 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__35686.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__35687))){
return ((function (pred__35686,expr__35687){
return (function (p1__35680_SHARP_){
return console.warn(p1__35680_SHARP_);
});
;})(pred__35686,expr__35687))
} else {
if(cljs.core.truth_(pred__35686.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__35687))){
return ((function (pred__35686,expr__35687){
return (function (p1__35681_SHARP_){
return console.debug(p1__35681_SHARP_);
});
;})(pred__35686,expr__35687))
} else {
if(cljs.core.truth_(pred__35686.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__35687))){
return ((function (pred__35686,expr__35687){
return (function (p1__35682_SHARP_){
return console.error(p1__35682_SHARP_);
});
;})(pred__35686,expr__35687))
} else {
return ((function (pred__35686,expr__35687){
return (function (p1__35683_SHARP_){
return console.log(p1__35683_SHARP_);
});
;})(pred__35686,expr__35687))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__35690){
...
var eval_fn = cljs.core.get.call(null,map__35691__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__35693_SHARP_);
});})(new_def))
);
...
return (function (p__35694){
var vec__35695 = p__35694;
var ky = cljs.core.nth.call(null,vec__35695,(0),null);
var v = cljs.core.nth.call(null,vec__35695,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1504549424599
