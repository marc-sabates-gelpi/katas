...
var or__28423__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj37316 = {"detail":data};
return obj37316;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__28411__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__28411__auto__)){
var and__28411__auto____$1 = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__37323 = cljs.core._EQ_;
var expr__37324 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__37323.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__37324))){
return ((function (pred__37323,expr__37324){
return (function (p1__37317_SHARP_){
return console.warn(p1__37317_SHARP_);
});
;})(pred__37323,expr__37324))
} else {
if(cljs.core.truth_(pred__37323.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__37324))){
return ((function (pred__37323,expr__37324){
return (function (p1__37318_SHARP_){
return console.debug(p1__37318_SHARP_);
});
;})(pred__37323,expr__37324))
} else {
if(cljs.core.truth_(pred__37323.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__37324))){
return ((function (pred__37323,expr__37324){
return (function (p1__37319_SHARP_){
return console.error(p1__37319_SHARP_);
});
;})(pred__37323,expr__37324))
} else {
return ((function (pred__37323,expr__37324){
return (function (p1__37320_SHARP_){
return console.log(p1__37320_SHARP_);
});
;})(pred__37323,expr__37324))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__37327){
...
var opts = map__37328__$1;
var eval_fn = cljs.core.get.call(null,map__37328__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__37330_SHARP_);
});})(new_def))
);
...
return (function (p__37331){
var vec__37332 = p__37331;
var ky = cljs.core.nth.call(null,vec__37332,(0),null);
...
if(cljs.core.truth_((function (){var and__28411__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1504733880077
