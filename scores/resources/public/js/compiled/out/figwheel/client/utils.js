...
return (new CustomEvent(event_name,(function (){var obj35690 = {"detail":data};
return obj35690;
})()));
} else {
...
var f = (function (){var pred__35697 = cljs.core._EQ_;
var expr__35698 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__35697.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__35698))){
return ((function (pred__35697,expr__35698){
return (function (p1__35691_SHARP_){
return console.warn(p1__35691_SHARP_);
});
;})(pred__35697,expr__35698))
} else {
if(cljs.core.truth_(pred__35697.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__35698))){
return ((function (pred__35697,expr__35698){
return (function (p1__35692_SHARP_){
return console.debug(p1__35692_SHARP_);
});
;})(pred__35697,expr__35698))
} else {
if(cljs.core.truth_(pred__35697.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__35698))){
return ((function (pred__35697,expr__35698){
return (function (p1__35693_SHARP_){
return console.error(p1__35693_SHARP_);
});
;})(pred__35697,expr__35698))
} else {
return ((function (pred__35697,expr__35698){
return (function (p1__35694_SHARP_){
return console.log(p1__35694_SHARP_);
});
;})(pred__35697,expr__35698))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__35701){
...
var opts = map__35702__$1;
var eval_fn = cljs.core.get.call(null,map__35702__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__35704_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__35706,(0),null);
...
}catch (e35711){if((e35711 instanceof Error)){
var e = e35711;
return not_found;
} else {
throw e35711;
...
//# sourceMappingURL=utils.js.map?rel=1504634397100
