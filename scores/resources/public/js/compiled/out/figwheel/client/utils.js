...
return (new CustomEvent(event_name,(function (){var obj35674 = {"detail":data};
return obj35674;
})()));
} else {
...
var f = (function (){var pred__35681 = cljs.core._EQ_;
var expr__35682 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__35681.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__35682))){
return ((function (pred__35681,expr__35682){
return (function (p1__35675_SHARP_){
return console.warn(p1__35675_SHARP_);
});
;})(pred__35681,expr__35682))
} else {
if(cljs.core.truth_(pred__35681.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__35682))){
return ((function (pred__35681,expr__35682){
return (function (p1__35676_SHARP_){
return console.debug(p1__35676_SHARP_);
});
;})(pred__35681,expr__35682))
} else {
if(cljs.core.truth_(pred__35681.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__35682))){
return ((function (pred__35681,expr__35682){
return (function (p1__35677_SHARP_){
return console.error(p1__35677_SHARP_);
});
;})(pred__35681,expr__35682))
} else {
return ((function (pred__35681,expr__35682){
return (function (p1__35678_SHARP_){
return console.log(p1__35678_SHARP_);
});
;})(pred__35681,expr__35682))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__35685){
var map__35686 = p__35685;
var map__35686__$1 = ((((!((map__35686 == null)))?((((map__35686.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__35686.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__35686):map__35686);
var opts = map__35686__$1;
var eval_fn = cljs.core.get.call(null,map__35686__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__35688_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__35690,(0),null);
var v = cljs.core.nth.call(null,vec__35690,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1504451415937
