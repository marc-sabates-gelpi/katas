...
var vec__32859_32862 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_32863 = cljs.core.nth.call(null,vec__32859_32862,(0),null);
var only_after_32864 = cljs.core.nth.call(null,vec__32859_32862,(1),null);
var db_changed_QMARK__32865 = (!((only_before_32863 == null))) || (!((only_after_32864 == null)));
if(db_changed_QMARK__32865){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_32863);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_32864);
...
var map__32866 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__32866__$1 = ((((!((map__32866 == null)))?((((map__32866.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__32866.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__32866):map__32866);
var db = cljs.core.get.call(null,map__32866__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__32866__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__32868 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__32868__$1 = ((((!((map__32868 == null)))?((((map__32868.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__32868.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__32868):map__32868);
var coeffects = map__32868__$1;
var event = cljs.core.get.call(null,map__32868__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__29592__auto___32871 = arguments.length;
var i__29593__auto___32872 = (0);
while(true){
if((i__29593__auto___32872 < len__29592__auto___32871)){
args__29599__auto__.push((arguments[i__29593__auto___32872]));

var G__32873 = (i__29593__auto___32872 + (1));
i__29593__auto___32872 = G__32873;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__29600__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq32870){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq32870));
});
...
var event = re_frame.interceptor.get_coeffect.call(null,context,new cljs.core.Keyword(null,"event","event",301435442));
var db = (function (){var or__28423__auto__ = re_frame.interceptor.get_effect.call(null,context,new cljs.core.Keyword(null,"db","db",993250759));
...
var args__29599__auto__ = [];
var len__29592__auto___32879 = arguments.length;
var i__29593__auto___32880 = (0);
while(true){
if((i__29593__auto___32880 < len__29592__auto___32879)){
args__29599__auto__.push((arguments[i__29593__auto___32880]));

var G__32881 = (i__29593__auto___32880 + (1));
i__29593__auto___32880 = G__32881;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__29600__auto__);
});
...
return cljs.core.get_in.call(null,new_db,p1__32874_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__32875_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__32875_SHARP_);
});})(new_db,old_db,new_ins))
,in_paths);
var changed_ins_QMARK_ = (function (){var and__28411__auto__ = cljs.core.contains_QMARK_.call(null,re_frame.interceptor.get_effect.call(null,context),new cljs.core.Keyword(null,"db","db",993250759));
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq32876){
var G__32877 = cljs.core.first.call(null,seq32876);
var seq32876__$1 = cljs.core.next.call(null,seq32876);
var G__32878 = cljs.core.first.call(null,seq32876__$1);
var seq32876__$2 = cljs.core.next.call(null,seq32876__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__32877,G__32878,seq32876__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1504733870760
