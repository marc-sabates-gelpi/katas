...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__31465 = cljs.core.instance_QMARK_;
var expr__31466 = reactive_val;
if(cljs.core.truth_(pred__31465.call(null,reagent.ratom.RAtom,expr__31466))){
return "ra";
} else {
if(cljs.core.truth_(pred__31465.call(null,reagent.ratom.RCursor,expr__31466))){
return "rc";
} else {
if(cljs.core.truth_(pred__31465.call(null,reagent.ratom.Reaction,expr__31466))){
return "rx";
} else {
if(cljs.core.truth_(pred__31465.call(null,reagent.ratom.Track,expr__31466))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1504733864682
