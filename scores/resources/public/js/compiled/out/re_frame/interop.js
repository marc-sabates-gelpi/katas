...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__30423 = cljs.core.instance_QMARK_;
var expr__30424 = reactive_val;
if(cljs.core.truth_(pred__30423.call(null,reagent.ratom.RAtom,expr__30424))){
return "ra";
} else {
if(cljs.core.truth_(pred__30423.call(null,reagent.ratom.RCursor,expr__30424))){
return "rc";
} else {
if(cljs.core.truth_(pred__30423.call(null,reagent.ratom.Reaction,expr__30424))){
return "rx";
} else {
if(cljs.core.truth_(pred__30423.call(null,reagent.ratom.Track,expr__30424))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1504634384555
