...
goog.addDependency("../scores/config.js", ['scores.config'], ['cljs.core']);
...
goog.addDependency("../scores/views.js", ['scores.views'], ['cljs.core', 're_frame.core']);
goog.addDependency("../scores/db.js", ['scores.db'], ['cljs.core']);
...
goog.addDependency("../scores/events.js", ['scores.events'], ['scores.db', 'reagent.core', 'cljs.core', 'scores.views', 'ajax.edn', 're_frame.core', 'day8.re_frame.http_fx']);
goog.addDependency("../scores/subs.js", ['scores.subs'], ['cljs.core', 're_frame.core']);
goog.addDependency("../scores/core.js", ['scores.core'], ['scores.config', 'reagent.core', 'cljs.core', 'scores.views', 'scores.events', 'scores.subs', 're_frame.core']);
...
goog.addDependency("../figwheel/connect/build_dev.js", ['figwheel.connect.build_dev'], ['cljs.core', 'scores.core', 'figwheel.client', 'figwheel.client.utils']);
